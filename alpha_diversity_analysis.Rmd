...
sobs.ni.AM <- S.obs(ninvasive.AM.ss[,-1])
sobs.ni.AM <- S.obs(ninvasive.AM.ss[,-1])
sobs.i.AM <- S.obs(invasive.AM.ss[,-1])
sobs.ni.ECM <- S.obs(ninvasive.ECM.ss[,-1])
sobs.i.ECM<- S.obs(invasive.ECM.ss[,-1])
...
SE.NI.AM <-(SimpE(ninvasive.AM.ss[,-1]))
SE.I.AM <-(SimpE(invasive.AM.ss[,-1]))
SE.NI.ECM<-(SimpE(ninvasive.ECM.ss[,-1]))
SE.I.ECM <-(SimpE(invasive.ECM.ss[,-1]))
