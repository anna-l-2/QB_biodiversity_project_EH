...
#super computationally expensive (+45 minutes)
library(future)
library(furrr)
plan(multisession) 
...
plot(scores(tree.dbrda, display = "wa"), xlim = c(-1.3, 1.1), 
...
points(scores(tree.dbrda, display = "wa"),
       pch = 19, cex = 3, bg = "gray", col = "gray")
text(scores(tree.dbrda, display = "wa"), 
     labels = row.names(scores(tree.dbrda, display = "wa")))

vectors <- scores(tree.dbrda, display = "bp")
